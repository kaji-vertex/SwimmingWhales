    ...
    articles = [
      {
        ...
        "desc2": "During the ar0m movement, the legs do the flutter kick making upward and downward movements with a pointed toe. This is a result-oriented kicking exercise to strengthen the ligament. Make sure the head is in line with the trunk looking straight down, extended arm with your palms turned downward.",
